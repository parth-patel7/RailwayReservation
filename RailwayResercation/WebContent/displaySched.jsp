...
<meta charset="UTF-8">
			...
			String station = request.getParameter("station");
      		...
      		try
      		{
      			...
      			if(operation.compareTo("a") == 0){
      	            ...
      	            out.println("	</tr>");
      			   rs = st.executeQuery("select * from Route where originSID = " +origin+ " and destSID = " +dest);
      			   while(rs.next()){
     	            	...
     	            	out.println("<th><a href=editScehd.jsp?rid="+rid+"&op=a>Edit</a></th>");
     	            	out.println("<th>|</th>");
      			...
      			//GIVEN STATION
      	            ...
      	            out.println("		<th>Status</th>");
      	            out.println("	</tr>");
      			   rs = st.executeQuery("select * from Route where originSID = " +station+ " or destSID = " +station);
      			   while(rs.next()){
      				 	String rid = rs.getString("RID");
     	            	...
     	            	out.println("<th>"+rs.getString("destSID")+"</th>");
     	          	  	out.println("<th>"+rs.getString("fare")+"</th>");
     	            	out.println("<th>"+rs.getString("status")+"</th>");
     	            	out.println("<th><a href=editSched.jsp?rid="+rid+"&op=b>Edit</a></th>");
     	            	out.println("<th>|</th>");
     	            	out.println("<th><a href=Test2.jsp?rid="+rid+"&op=d>Delete</a></th>");
     	            	out.println("</tr>");		    
      			   }
   ...
   <a href='manageSchedule.jsp'>back </a>
   </body>
